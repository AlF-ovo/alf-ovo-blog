...
![程序逻辑](/attachments/ctfshow/test_your_nc/pwn3/01-main.png)

![case 分析](/attachments/ctfshow/test_your_nc/pwn3/02-case.png)

![选择 6](/attachments/ctfshow/test_your_nc/pwn3/03-choose-6.png)

看过逻辑后就能确定答案是 `case 6`。  
`nc` 连入后选择 `6`，直接拿 flag。

![拿到 flag](/attachments/ctfshow/test_your_nc/pwn3/04-flag.png)
