...
![程序信息](/alf-ovo-blog/attachments/ctfshow/test_your_nc/pwn1/01-checksec.png)

![反汇编结果](/alf-ovo-blog/attachments/ctfshow/test_your_nc/pwn1/02-disasm.png)

反汇编看一眼就能知道，直接用 `nc` 连上即可获得 flag。

![拿到 flag](/alf-ovo-blog/attachments/ctfshow/test_your_nc/pwn1/03-flag.png)
