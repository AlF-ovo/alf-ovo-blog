...
updated: 2026-04-17
description: 一道典型的堆风水 + 越界写 + free@got 劫持题，整理程序结构、漏洞点、利用链和站内附件下载。
...
![堆风水示意 1](./heap-layout-1.png)

![堆风水示意 2](./heap-layout-2.png)
...
- [下载题目附件 `pwn`](../../attachments/ctfshow_pwn/pwn160/pwn)
- [下载利用脚本 `exp.py`](../../attachments/ctfshow_pwn/pwn160/exp.py)
...
脚本见：[exp.py](../../attachments/ctfshow_pwn/pwn160/exp.py)
