...
updated: 2026-04-17
description: 围绕单全局指针的 realloc/free 逻辑做两段利用，先伪造 stdout 泄露 libc，再打 __free_hook -> system。
...
- [下载题目附件 `pwn`](../../attachments/ctfshow_pwn/pwn164/pwn)
- [下载利用脚本 `exp.py`](../../attachments/ctfshow_pwn/pwn164/exp.py)
- [下载对应 libc `libc-2.27.so`](../../attachments/ctfshow_pwn/pwn164/libc-2.27.so)
