...
![连接后的界面](/attachments/ctfshow/test_your_nc/pwn2/01-landing.png)

![获得 shell](/attachments/ctfshow/test_your_nc/pwn2/02-shell.png)

题目直接给了 shell，之后就是 `nc` 连入，执行 `ls` 和 `cat flag` 即可。

![拿到 flag](/attachments/ctfshow/test_your_nc/pwn2/03-flag.png)
